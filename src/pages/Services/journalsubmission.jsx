...
const JournalSubmissionSupport = () => {
  ...
  return (
    <div className="manuscript-editing">
      ...
      {/* ---------- SEO METADATA ---------- */}
      <Helmet>
        <title>"Publication Verse | Journal Submission Support"</title>
        ...
        <meta 
          name="keywords" 
          content="Professional support for journal submissions including formatting, cover letters, and compliance checks." 
        />
      ...
      <section className="manuscript-hero">
        <div className="manuscript-hero-content">
          <h1>Journal Submission Support</h1>
          <p>
            We assist you in submitting your manuscript to the right journal, ensuring formatting, cover letters, and requirements are perfectly handled.
          </p>
        </div>
      </section>
      ...
      <section className="manuscript-info">
        <div className="manuscript-left">
          <h2>Why Choose Us for Journal Submission?</h2>
          <p>
            Our Journal Submission Support service handles the entire submission process for you—saving time, reducing stress, and ensuring accuracy. We prepare all required documents, format your manuscript to the journal’s exact guidelines, write a compelling cover letter, and complete the submission portal steps on your behalf. By ensuring every detail is correct and compliant, we maximize your chances of smooth acceptance without unnecessary delays or rejections.
          </p>
        </div>

        <div className="manuscript-right">
          <img src="/images/services8.png" alt="Manuscript Editing" />
        </div>
      </section>
      ...
      <section className="manuscript-tagline">
        ...
        <div className="tagline-content">
          <h3>Submit. Comply. Get Accepted!</h3>
          <p>Maximize your chances for successful journal acceptance.</p>
        </div>
...
export default JournalSubmissionSupport;
