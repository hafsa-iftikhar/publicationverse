...
const ThesisToArticle = () => {
  ...
  return (
    <div className="manuscript-editing">
      ...
      {/* ---------- SEO METADATA ---------- */}
      <Helmet>
        <title>Publication Verse | Thesis to Article Conversion</title>

        <meta 
          name="description" 
          content="Expert services to convert your thesis into a journal-ready research article." 
        />
      ...
      <section className="manuscript-hero">
        <div className="manuscript-hero-content">
          <h1>Thesis to Article Conversion</h1>
          <p>
            We help you convert your thesis into a high-quality research article suitable for journal publication.
          </p>
        </div>
      </section>
      {/* ---------- INFO SECTION ---------- */}
      <section className="manuscript-info">
        <div className="manuscript-left">
          <h2>Why Choose Us for Thesis to Article Conversion?</h2>
          <p>
           Our Thesis to Article Conversion service condenses your lengthy thesis into a clear, focused, and impactful research article. We identify the core findings, refine your argument, restructure sections, rewrite content for journal standards, and highlight the novelty of your work. This ensures your research reaches a wider academic audience and stands a strong chance of publication in reputable journals.
          </p>
        </div>

        <div className="manuscript-right">
          <img src="/images/services1.png" alt="Manuscript Editing" />
        </div>
      </section>
      ...
      <section className="manuscript-tagline">
        ...
        <div className="tagline-content">
          <h3>From Thesis to Publication!</h3>
          <p>Convert your research into journal-ready articles efficiently.</p>
        </div>
...
export default ThesisToArticle;
