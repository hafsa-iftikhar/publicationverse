...
const ReviewerCommentSupport = () => {
  ...
  return (
    <div className="manuscript-editing">
      ...
      {/* ---------- SEO METADATA ---------- */}
      <Helmet>
        <title>Publication Verse | Reviewer Comment Support</title>

        <meta 
          name="description" 
          content="Professional support for responding to reviewer comments for smoother manuscript acceptance." 
        />
      ...
      <section className="manuscript-hero">
        <div className="manuscript-hero-content">
          <h1>Reviewer Comment Support</h1>
          <p>
            We help you respond to peer review comments effectively, improving your chances of acceptance without unnecessary delays.
          </p>
        </div>
      </section>
      {/* ---------- INFO SECTION ---------- */}
      <section className="manuscript-info">
        <div className="manuscript-left">
          <h2>Why Choose Us for Reviewer Comment Support?</h2>
          <p>
            Responding to reviewer comments can be challenging, and our Reviewer Comment Support ensures your revisions are clear, respectful, and persuasive. We help you interpret complex reviewer feedback, strengthen your manuscript, and prepare professionally written responses that address each point thoroughly. Our guidance improves clarity, enhances scientific validity, and increases the likelihood of your manuscript moving toward acceptance.
          </p>
        </div>

        <div className="manuscript-right">
          <img src="/images/services5.png" alt="Manuscript Editing" />
        </div>
      </section>
      ...
      <section className="manuscript-tagline">
        ...
        <div className="tagline-content">
          <h3>Answer With Clarity!</h3>
          <p>Transform reviewer feedback into successful acceptance.</p>
        </div>
...
export default ReviewerCommentSupport;
